...
module.exports = {
    ...
    SESSION_ID: process.env.SESSION_ID || "MEGALODON~MD~cVJ3SY4b#Zmmbu3WRwzhvO5S0hO6OXF_0uBxQUPlTc0jpclh-M4c",  // Your bot's session ID (keep it secure)
    ...
    OWNER_NUMBER: process.env.OWNER_NUMBER || "50935073888",  // Owner's WhatsApp number
